describe('User manual', () => {
  beforeEach(function () {
    ...
    it("User manual -- De", function () {
        ...
        cy.get('[id="burger_menu_link"]')
        .click();
        cy.get('[id="burger_menu"] > .dropdown-menu > li:nth-child(7) > a').should("to.exist");

        // test find.mr.beam website url & title
        cy.get('[id="burger_menu"] > .dropdown-menu > li:nth-child(7) > a').invoke('removeAttr', 'target').click({force: true});
    ...
    it("User manual -- Es", function () {
        ...
        cy.get('[id="burger_menu_link"]')
        .click();
        cy.get('[id="burger_menu"] > .dropdown-menu > li:nth-child(8) > a').should("to.exist");

        // test find.mr.beam website url & title
        cy.get('[id="burger_menu"] > .dropdown-menu > li:nth-child(8) > a').invoke('removeAttr', 'target').click({force: true});
