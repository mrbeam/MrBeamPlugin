describe("Navbar icons", function () {
    ...
    it("Download backup", function () {
        cy.get('[id="settings_plugin_mrbeam_custom_material_link"]').click();
        cy.get(
            '[data-test="custom-material-settings-backup]'
        )
            .click()
    ...
    it("Restore", function () {
        cy.get('[id="settings_plugin_mrbeam_custom_material_link"]').click();
        const filepathSvg = "MrBeam-CustomMaterialBackup-2022-12-08.json";
        cy.get('[data-test="custom-material-settings-input-file"]').attachFile(filepathSvg);
