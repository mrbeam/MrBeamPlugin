describe("Laser Job", function() {
    ...
    it('Add texts', function() { 
       ...
       cy.get('[id="laserhead_focus_reminder_modal"]').find('.btn').first().click();
       cy.get('[id="laser_button"]').click();
       cy.get('.material_entry').contains('Felt').click({force:true});
       cy.get('[id="material_color_6fa8dc"]').click();
       cy.wait(1000);
       cy.get('[id="material_thickness_3"]').click();
    ...
    it('Add shapes', function() { 
       ...
       cy.get('[id="material_color_000000"]').click();
       cy.wait(1000);
