describe("Login", function () {
    ...
    xit("Upload designs by clicking", function () {
    ...
    xit("Delete designs by burger menu", function () {
        cy.get(".files_template_model_svg")
            .first()
    ...
    xit("Open folder and click back", function () {
        cy.get(".preview").eq(0).click({ force: true });
        cy.get(".back-arrow").click();
        cy.logout();
    });

    xit("Delete folder by burger menu", function () {
        cy.get(
    ...
    xit("Download designs by burger menu", function () {
        cy.intercept(
            "GET",
