describe("Login", function () {
    ...
    data -
        cy("Upload designs by clicking", function () {
    ...
    data -
        cy("Delete designs by burger menu", function () {
            cy.get(".files_template_model_svg")
                .first()
    ...
    data -
        cy("Open folder and click back", function () {
    ...
    data -
        cy("Delete folder by burger menu", function () {
            cy.get(
    ...
    data -
        cy("Download designs by burger menu", function () {
            cy.intercept(
                "GET",
                Cypress.config().baseUrl +
                    "/downloads/files/local/Test_plan_1.svg"
            ).as("downloadFile");
            cy.get(".files_template_model_svg")
                .first()
                .find(".icon-reorder")
