...
def get_path_d(node):
	...
	# polygon
	elif node.tag == _add_ns('polygon', 'svg') or node.tag == 'polygon' \
	or node.tag == _add_ns('polyline', 'svg') or node.tag == 'polyline':
		# Convert
		#
	...
	# circle / ellipse
	elif node.tag == _add_ns('ellipse', 'svg') or \
		node.tag == 'ellipse' or \
		node.tag == _add_ns('circle', 'svg') or \
		node.tag == 'circle':
