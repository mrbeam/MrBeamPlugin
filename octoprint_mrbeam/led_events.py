...
class LedEventListener(CommandTrigger):
	...
	LED_EVENTS[MrBeamEvents.RAW_IMAGE_TAKING_START] = "mrbeam_ledstrips_cli color:100:0:255:1:50"
	...
	LED_EVENTS[MrBeamEvents.LENS_CALIB_RUNNING]     = "mrbeam_ledstrips_cli flash_green:1:15"
