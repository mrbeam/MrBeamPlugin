...
class LedEventListener(CommandTrigger):
	...
	LED_EVENTS[MrBeamEvents.LASER_JOB_DONE] = "mrbeam_ledstrips_cli PrintDone"
	LED_EVENTS[MrBeamEvents.LASER_JOB_CANCELLED] = "mrbeam_ledstrips_cli PrintCancelled"
	LED_EVENTS[MrBeamEvents.LASER_JOB_FAILED] = "mrbeam_ledstrips_cli Error"
