...
class Migration(object):
	...
	VERSION_MOUNT_MANAGER_170                = '0.6.14.2'
	...
	MOUNT_MANAGER_VERSION = StrictVersion("1.7.0")
	...
	def run(self):
		try:
			...
			if self.is_migration_required() and not self.suppress_migrations:
				...
				if self.version_previous is None or self._compare_versions(self.version_previous, self.VERSION_MOUNT_MANAGER_170, equal_ok=False):
