        ...
        self.onEventSafecutterResponse = function (payload) {
                    ...
                    if ([1,2,4,8].includes(payload["value"])) {
                        ...
                        switch (payload["value"]) {
                            case 1:
                                imageElement.attr("src","/plugin/mrbeam/static/img/CO.jpg");
                                break;
                            case 2:
                                imageElement.attr("src","/plugin/mrbeam/static/img/pvc.jpg");
                                break;
                            case 4:
                                imageElement.attr("src","/plugin/mrbeam/static/img/formaldehyde.jpg");
                                break;
                            case 8:
                                imageElement.attr("src","/plugin/mrbeam/static/img/dust.jpg");
                                break;
                        }
