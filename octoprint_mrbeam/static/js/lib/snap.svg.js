...
\*/
    ...
    \*/
        ...
        function $(el, attr) {
            if (attr) {
                if (el == "#text") {
                    el = glob.doc.createTextNode(
                        attr.text || attr["#text"] || ""
                    );
                }
                if (el == "#comment") {
                    el = glob.doc.createComment(
                        attr.text || attr["#text"] || ""
                    );
                }
                if (typeof el == "string") {
...
\*/
        ...
        Snap.closestPoint = function (path, x, y) {
            ...
            var pathNode = path.node,
                ...
                precision =
                    (pathLength / pathNode.pathSegList.numberOfItems) * 0.125,
                best,
                bestLength,
...
\*/
        Snap.rgb = cacher(function (r, g, b, o) {
            if (is(o, "finite")) {
                ...
                return (
                    "rgba(" +
                    [round(r), round(g), round(b), +o.toFixed(2)] +
                    ")"
                );
            }
            return (
...
\*/
        var parseTransformString = (Snap.parseTransformString = function (
            TString
        ) {
            if (!TString) {
                return null;
...
\*/
        ...
        function wrap(dom) {
            ...
            if (
                ...
                return new Paper(
                    dom.contentDocument.getElementsByTagName("svg")[0]
                );
            }
...
\*/
        ...
        \*/
            matrixproto.toTransformString = function (shorter) {
                ...
                if (!+s.shear.toFixed(9)) {
                    ...
                    return (
                        (s.dx || s.dy
                            ? "t" + [+s.dx.toFixed(4), +s.dy.toFixed(4)]
                            : E) +
        ...
        function fillStroke(name) {
            return function (value) {
                ...
                if (value instanceof Element) {
                    ...
                    if (fill.error) {
                        var grad = Snap(
                            getSomeDefs(this).ownerSVGElement
                        ).gradient(value);
                        if (grad) {
                            if (!grad.node.id) {
                                $(grad.node, {
            ...
            function getter(end) {
                return function () {
                    ...
                    if (style == "none") {
                        ...
                        return Snap(
                            glob.doc.getElementById(style.match(reURLValue)[1])
                        );
                    }
                };
            }
        ...
        function textExtract(node) {
            ...
            for (var i = 0, ii = children.length; i < ii; i++) {
                ...
                if (chi.tagName == "tspan") {
                    if (
                        chi.childNodes.length == 1 &&
                        chi.firstChild.nodeType == 3
                    ) {
    ...
    Snap.plugin(function (Snap, Element, Paper, glob) {
        ...
        function pathToAbsolute(pathArray) {
            ...
            if (
                !is(pathArray, "array") ||
                !is(pathArray && pathArray[0], "array")
            ) {
                // rough assumption
                pathArray = Snap.parsePathString(pathArray);
            }
                ...
                if (pa0 != pa0.toUpperCase()) {
                    ...
                    switch (r[0]) {
                        ...
                        case "U":
                            res.pop();
                            res = res.concat(
                                ellipsePath(x, y, pa[1], pa[2], pa[3])
                            );
    ...
    \*/
        setproto.animate = function (attrs, ms, easing, callback) {
            ...
            if (
                Snap.is(attrs, "array") &&
                Snap.is(args[args.length - 1], "array")
            ) {
                var each = true;
            }
            var begin,
    ...
    Snap.plugin(function (Snap, Element, Paper, glob) {
        ...
        function equaliseTransform(t1, t2, getBBox) {
            ...
            for (; i < maxlength; i++) {
                ...
                to[i] = [];
                for (
                    j = 0, jj = Math.max(tt1.length, tt2.length);
                    j < jj;
                    j++
                ) {
        ...
        function getPath(path) {
            ...
            return Function(
                "val",
                "return Snap.path.toString.call([" + b + "])"
            );
        }
    ...
    Snap.plugin(function (Snap, Element, Paper, glob) {
        var elproto = Element.prototype,
            ...
            getScroll = function (xy, el) {
                ...
                return doc[
                    name in doc.documentElement ? "documentElement" : "body"
                ][name];
            },
            ...
            addEvent = function (obj, type, fn, element) {
                var realName =
                        supportsTouch && touchMap[type] ? touchMap[type] : type,
                    f = function (e) {
    ...
    \*/
        for (var i = events.length; i--; ) {
            (function (eventName) {
                ...
                Snap["un" + eventName] = elproto["un" + eventName] = function (
                    fn
                ) {
