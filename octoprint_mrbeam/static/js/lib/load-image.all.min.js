!(function (o) {
    ...
    (r.fetchBlob = function (e, t) {
        ...
        (r.readFile = function (e, t, i) {
            if (o.FileReader) {
                ...
                if (((a.onload = a.onerror = t), a[(i = i || "readAsDataURL")]))
                    return a[i](e), a;
            }
            return !1;
        }),
    ...
    (function (e) {
        ...
        "function" == typeof define && define.amd
            ? define(
                  ["../../../../../../tmp/JavaScript-Load-Image/js/load-image"],
                  e
              )
            : "object" == typeof module && module.exports
            ? e(
                  require("../../../../../../tmp/JavaScript-Load-Image/js/load-image")
              )
            : e(window.loadImage);
    })(function (I) {
        "use strict";
        ...
        (I.transform = function (e, t, i, a, o) {
            ...
            (I.renderImageToCanvas = function (e, t, i, a, o, n, r, s, l, c) {
                return (
                    e.getContext("2d").drawImage(t, i, a, o, n, r, s, l, c), e
                );
            }),
            ...
            (I.scale = function (e, t, i) {
                ...
                if (
                    ...
                    if (
                        ...
                        for (; y < s * f; )
                            (p.width = s * f),
                                ...
                                (s = p.width),
                                (l = p.height),
                                ((e = document.createElement("canvas")).width =
                                    s),
                                (e.height = l),
                                I.renderImageToCanvas(
                                    e,
                    ...
                    return (
                        ...
                        I.renderImageToCanvas(p, e, c, d, s, l, 0, 0, y, S)
                    );
                }
            ...
            (p.parseMetaData = function (e, d, u, f) {
                ...
                (!!(
                    ...
                    p.readFile(
                        ...
                        function (e) {
                            if (e.target.error)
                                return console.log(e.target.error), void d(f);
                            var t,
                                i,
                                a,
                                o,
                            ...
                            if (65496 === r.getUint16(0)) {
                                for (
                                    ;
                                    s < l &&
                                    ((65504 <= (t = r.getUint16(s)) &&
                                        t <= 65519) ||
                                        65534 === t);

                                ) {
                                    if (
                                        s + (i = r.getUint16(s + 2) + 2) >
                                        r.byteLength
                                    ) {
                                        console.log(
    ...
    (function (e) {
        ...
        "function" == typeof define && define.amd
            ...
            ? e(
                  require("../../../../../../tmp/JavaScript-Load-Image/js/load-image"),
                  require("../../../../../../tmp/JavaScript-Load-Image/js/load-image-meta")
              )
            : e(window.loadImage);
    })(function (o) {
        "use strict";
    ...
    (function (e) {
        ...
        "function" == typeof define && define.amd
            ...
            ? e(
                  require("../../../../../../tmp/JavaScript-Load-Image/js/load-image"),
                  require("../../../../../../tmp/JavaScript-Load-Image/js/load-image-scale"),
                  require("../../../../../../tmp/JavaScript-Load-Image/js/load-image-meta")
              )
            : e(window.loadImage);
    })(function (l) {
        ...
        (g.ExifMap = function () {
            ...
            (g.getExifThumbnail = function (e, t, i) {
                if (i && !(t + i > e.byteLength))
                    return g.createObjectURL(
                        new Blob([e.buffer.slice(t, t + i)])
                    );
    ...
    (function (e) {
        ...
        "function" == typeof define && define.amd
            ...
            ? e(
                  require("../../../../../../tmp/JavaScript-Load-Image/js/load-image"),
                  require("../../../../../../tmp/JavaScript-Load-Image/js/load-image-exif")
              )
            : e(window.loadImage);
    })(function (e) {
        "use strict";
        (e.ExifMap.prototype.tags = {
            ...
            (function (e) {
                var t,
                    ...
                    a = e.map;
                for (t in i)
                    Object.prototype.hasOwnProperty.call(i, t) && (a[i[t]] = t);
            })(e.ExifMap.prototype),
            ...
            (u.parseIptcData = function (e, t, i, a, o) {
                if (!o.disableIptc) {
                    for (var n, r, s = t + i; t + 8 < s; ) {
                        if (
                            ((r = t),
                            943868237 === (n = e).getUint32(r) &&
                                1028 === n.getUint16(r + 4))
                        ) {
                            ...
                            return (
                                (a.iptc = new u.IptcMap()),
                                u.parseIptcTags(e, c, d, a)
                            );
                        }
                        t++;
                    }
    ...
    (function (e) {
        ...
        "function" == typeof define && define.amd
            ...
            ? e(
                  require("../../../../../../tmp/JavaScript-Load-Image/js/load-image"),
                  require("../../../../../../tmp/JavaScript-Load-Image/js/load-image-iptc")
              )
            : e(window.loadImage);
    })(function (e) {
        "use strict";
