...
(function (global, factory) {
    ...
    var hasJquery =
        (typeof jQuery === "undefined" ? "undefined" : _typeof(jQuery)) !==
        undefinedStr;
    ...
    HopscotchBubble.prototype = {
        ...
        init: function init(initOpt) {
            ...
            initOpt =
                (typeof initOpt === "undefined"
                    ? "undefined"
                    : _typeof(initOpt)) === undefinedStr
                    ? {}
                    : initOpt;
    ...
    Hopscotch = function Hopscotch(initOptions) {
        var self = this,
                ...
                // Smooth scroll to scroll target
                    ...
                    if (
                        (typeof YAHOO === "undefined"
                            ? "undefined"
                            : _typeof(YAHOO)) !== undefinedStr &&
                        _typeof(YAHOO.env) !== undefinedStr &&
                        _typeof(YAHOO.env.ua) !== undefinedStr &&
                        _typeof(YAHOO.util) !== undefinedStr &&
                        _typeof(YAHOO.util.Scroll) !== undefinedStr
                    ) {
             ...
             * target on the page?)
             */
            findStartingStep = function findStartingStep(
                startStepNum,
                savedSkippedSteps,
                cb
            ) {
        ...
        this.getCalloutManager = function () {
            if (
                (typeof calloutMgr === "undefined"
                    ? "undefined"
                    : _typeof(calloutMgr)) === undefinedStr
            ) {
        ...
        this.startTour = function (tour, stepNum) {
            ...
            if (
                (typeof stepNum === "undefined"
                    ? "undefined"
                    : _typeof(stepNum)) !== undefinedStr
            ) {
            ...
            if (
                ...
                (typeof cookieTourStep === "undefined"
                    ? "undefined"
                    : _typeof(cookieTourStep)) !== undefinedStr
            ) {
        ...
        this.setRenderer = function (render) {
            var typeOfRender =
                typeof render === "undefined" ? "undefined" : _typeof(render);
