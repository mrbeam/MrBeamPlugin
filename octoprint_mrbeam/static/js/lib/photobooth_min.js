...
Photobooth = function (e) {
    ...
    var n = function (e) {
        ...
        r = function (e) {
            (this.startX = 0),
                (this.startY = 0),
                e.addEventListener("mousedown", this, !1);
        };
    (r.prototype.onStart = function (e, t) {}),
        (r.prototype.onMove = function (e, t) {}),
        (r.prototype.onStop = function (e, t) {}),
    ...
    var i = function (e, t) {
            e.innerHTML =
                '<div class="submenu"><div class="tip"></div><div class="slider"><div class="track"></div><div class="handle" style="left:50px"><div></div></div></div></div>';
            var i = 50,
                s = 50,
        ...
        s = function (e, t, i) {
            (this.setMax = function (e, n) {
                ...
                (this.getData = function () {
                    return { x: s, y: o, width: u, height: a };
                }),
                ...
                (this.toggle = function () {
                    p === !1
                        ? ((d.style.opacity = 1), (p = !0))
                        : ((d.style.opacity = 0), (p = !1));
                });
            var s = 30,
                o = 30,
                u = 100,
            ...
            (d.className = "resizehandle"),
                (d.innerHTML = '<div class="handle"><div></div></div>'),
                e.appendChild(d);
            ...
            (m.onMove = function (e, n) {
                s + e + u < t &&
                    s + e > 0 &&
                    ((f = s + e), (d.style.left = f + "px")),
                    o + n + a < i &&
                        o + n > 0 &&
                        ((l = o + n), (d.style.top = l + "px"));
            }),
                (m.onStop = function () {
                    (s = f), (o = l);
                });
            ...
            (y.onMove = function (e, n) {
                s + e + u < t &&
                    u + e > 18 &&
                    ((c = u + e), (d.style.width = c + "px")),
                    o + n + a < i &&
                        a + n > 18 &&
                        ((h = a + n), (d.style.height = h + "px"));
            }),
                (y.onStop = function () {
                    (u = c), (a = h);
                });
        ...
        v = function (e, t) {
            if (e < -0.5 || e > 0.5)
                throw "Invalid value: " + t + " must be between 0 and 1";
            return !0;
        },
        m =
    ...
    g("trigger").onclick = function () {
        ...
        C.isActive()
            ...
            : (e = { x: 0, y: 0, width: p, height: d });
        var t = y("canvas");
        (t.width = e.width), (t.height = e.height);
        if (f)
            t.getContext("2d").drawImage(
                T,
                Math.max(0, e.x - (p - T.videoWidth) / 2),
                Math.max(e.y - (d - T.videoHeight) / 2),
                e.width,
                e.height,
                0,
                0,
    ...
    var A = function (e) {
            c = e;
            try {
                (T.src = (window.URL || window.webkitURL).createObjectURL(c)),
                    m(H);
            } catch (t) {
                (T.mozSrcObject = c),
                    h.forceHSB === !1
                        ? ((f = !0),
                          b.appendChild(T),
                          (b.getElementsByTagName("ul")[0].className = "noHSB"))
                        : T.addEventListener(
                              "canplay",
                              function () {
                                  m(H);
        ...
        M = function () {
            (N.style.display = "none"), t.call(navigator, { video: !0 }, A, O);
        },
        _ = function (e, t, n) {
            return (
                n < 0 && (n += 1),
        ...
        H = function () {
            ...
            for (var r = 0; r < n.length; r += 4) {
                ...
                if (c == h) v = g = 0;
                    ...
                    var b = c - h;
                    (g = y > 0.5 ? b / (2 - c - h) : b / (c + h)),
                        c === i && (v = ((s - f) / b + (s < f ? 6 : 0)) / 6),
                        c === s && (v = ((f - i) / b + 2) / 6),
                        c === f && (v = ((i - s) / b + 4) / 6);
                }
    ...
    this.resize(p, d),
        e.appendChild(b),
        t ? m(M) : (g("notSupported").style.display = "block");
};
/**
