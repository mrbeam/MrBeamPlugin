            ...
            for (i = n - 1; i >= 0; i--) {
                ...
                while (1) {
                    ...
                    if (Math.abs(cur.x) <= 1 && Math.abs(cur.y) <= 1) {
                        ...
                        off.x =
                            cur.x +
                            (cur.y >= 0 && (cur.y > 0 || cur.x < 0) ? 1 : -1);
                        off.y =
                            cur.y +
                            (cur.x <= 0 && (cur.x < 0 || cur.y < 0) ? 1 : -1);
        ...
        function optiCurve(path) {
            ...
            function opti_penalty(path, i, j, res, opttolerance, convc, areac) {
                ...
                for (k = k1; k != j; k = k1) {
                    ...
                    if (
                        sign(
                            cprod(vertex[i], vertex[i1], vertex[k1], vertex[k2])
                        ) != conv
                    ) {
                        return 1;
                    }
                ...
                area -=
                    dpara(vertex[0], curve.c[i * 3 + 2], curve.c[j * 3 + 2]) /
                    2;
                if (i >= j) {
                    area += areac[m];
                }
            ...
            for (i = 0; i < m; i++) {
                ...
                if (curve.tag[i1] == "CURVE") {
                    ...
                    area +=
                        ...
                        2;
                    area +=
                        dpara(p0, curve.c[i * 3 + 2], curve.c[i1 * 3 + 2]) / 2;
                }
                areac[i + 1] = area;
            }
