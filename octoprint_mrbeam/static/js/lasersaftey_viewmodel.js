        ...
        self.onUserLoggedIn = function (currentUser) {
            ...
            if (currentUser) {
                if (currentUser.settings && currentUser.settings.mrbeam) {
                    ...
                    if (!beamSettings.ts) {
                        console.log(
                            "This is not a valid user thingy... reloading"
                        );
        ...
        self._handleExit = function () {
            if (self.allChecked()) {
                ...
                showMessageDialog({
                    ...
                    message: gettext(
                        "Please read the entire document and indicate that you understood and agree by checking all checkboxes."
                    ),
                });
        ...
        self._sendData = function (data) {
            OctoPrint.simpleApiCommand(
                ...
                new PNotify({
                    ...
                    text: gettext(
                        "Device needs to have a working internet connection to submit your confirmation. We aren't able to reach our servers therefore we'll show this warning again."
                    ),
                    type: "warning",
                    hide: true,
                });
