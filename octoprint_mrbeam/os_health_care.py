    ...
    def run(self):
        ...
        try:
            ...
            self._logger.exception(
                "Exception when running the OS heath care: {}".format(e)
            )
    ...
    def etc_network_interfaces(self):
        ...
        for i in range(max_retries):
            ...
            if ok_eth0 and ok_wlan0:
                ...
                self._logger.warn(
                    "Failed test on ifup command: eth0: %s, wlan0: %s - Retrying in %ss",
                    ok_eth0,
                    ok_wlan0,
                    sleep_time,
                )
        ...
        if needs_fix:
            ...
            out, code = exec_cmd_output(
                [
                    "sudo",
                    "cp",
                    self._get_full_path_to_file("interfaces"),
