...
from octoprint_mrbeam.camera.undistort import prepareImage, _getCamParams, MAX_OBJ_HEIGHT, \
	CAMERA_HEIGHT, _getCamParams,  DIST_KEY, MTX_KEY, ERR_NEED_CALIB, need_corner_calibration
from octoprint_mrbeam.camera.calibration import BoardDetectorDaemon, MIN_BOARDS_DETECTED, FACTORY
...
class LidHandler(object):
	...
	def onEvent(self, event, payload):
		...
		if event == IoBeamEvents.INTERLOCK_CLOSED:
			...
			pic_settings = get_corner_calibration(self._settings.get(["cam", "correctionSettingsFile"]))
