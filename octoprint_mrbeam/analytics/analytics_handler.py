...
class AnalyticsHandler(object):
    ...
    def add_iobeam_message_log(self, iobeam_version, message, from_plugin=False):
        try:
            ...
            self._logger.exception(
                "Exception during add_iobeam_message_log: {}".format(e), analytics=True
            )

    def add_iobeam_i2c_monitoring(
        self, iobeam_version, state, method, current_devices, lost_devices, new_devices
    ):
        try:
            iobeam_data = {
            ...
            self._logger.exception(
                "Exception during add_iobeam_i2c_monitoring: {}".format(e),
                analytics=True,
            )
