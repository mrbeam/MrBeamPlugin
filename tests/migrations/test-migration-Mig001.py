...
class TestMigrationMig001(unittest.TestCase):
    ...
    def test_beamos_versions(self):
        ...
        self.assertTrue(self.m001.shouldrun(Mig001NetconnectdDisableLogDebugLevel, "0.18.1"))

        # not matching pattern strings
        self.assertFalse(self.m001.shouldrun(Mig001NetconnectdDisableLogDebugLevel, None))
        self.assertFalse(self.m001.shouldrun(Mig001NetconnectdDisableLogDebugLevel, "14.0"))
        self.assertFalse(self.m001.shouldrun(Mig001NetconnectdDisableLogDebugLevel, "0"))
