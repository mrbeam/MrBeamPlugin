...
def inspectState(data):
    ...
    if isinstance(data, dict):
        ...
        logging.error('Data returned by state should be dict. Instead data : %s, %s',
                        type(data), data)
...
def test_lens_calibration_abort(datafiles):
    ...
    b = BoardDetectorDaemon(out_file, runCalibrationAsap=True, stateChangeCallback=inspectState)
