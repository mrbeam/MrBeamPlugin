...
class TestBurgerMenuService(TestCase):
    ...
    @patch('octoprint_mrbeam.service.burger_menu_service.get_locale')
    ...
    @patch('octoprint_mrbeam.service.burger_menu_service.MrBeamDocUtils.get_mrbeam_definitions_for')
    @patch('octoprint_mrbeam.service.burger_menu_service.get_locale')
    ...
    @patch('octoprint_mrbeam.service.burger_menu_service.MrBeamDocUtils.get_mrbeam_definitions_for')
    @patch('octoprint_mrbeam.service.document_service.gettext')
    @patch('octoprint_mrbeam.service.burger_menu_service.get_locale')
